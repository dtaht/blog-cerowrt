...
T='ecn-nmfixed-bedroom-fqcodel-tim'
# Make sure we're alive

fping -c 3 $S0 $S1
flent -l 60 --step-size=.05 -H $S0 -H $S0 -H $S0 -H $S0  -t "$T-up" rtt_fair_up
flent -l 60 --step-size=.05 --swap-up-down -H $S0 -H $S0 -H $S0 -H $S0  -t "$T-down" rtt_fair_up
