...
$F -H lite-3 -H m2-1 -H lite-1 -H lite-2  -t "routers-txpower_20-adhoc-one-hop-4-station-m2-ht40" rtt_fair4be
$F -H c2 -H m2-1 -H lite-1 -H lite-2  -t "with-c2-txpower_20-adhoc-one-hop-4-station-m2-ht40" rtt_fair4be
for i in 1 2 3 4 5
do
for i in up down
do
$F -H lite-3 -H m2-1 -H lite-1 -H lite-2 -t "routers-txpower-20-stats-adhoc-one-hop-4-station-m2-ht40-$i" rtt_fair_var_$i
$F -H c2 -H m2-1 -H lite-1 -H lite-2 -t "with-c2-txpower-20-stats-adhoc-one-hop-4-station-m2-ht40-$i" rtt_fair_var_$i
done 
done
exit 0

$F -H lite-3 -H m2-1 -H lite-1 -H lite-2 -t "adhoc-one-hop-4-station-ht40" rtt_fair_var
