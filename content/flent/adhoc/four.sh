...
$F -H lite-3 -H lite-2 -H lite-1 -H archer-3 -t "adhoc-one-hop-4-station" rtt_fair4be
for i in up down
do
$F -H lite-3 -H lite-2 -H lite-1 -H archer-3 -t "adhoc-one-hop-4-station" rtt_fair_var_$i
done 
