...
for i in up down
do
$F -H lite-3 -H lite-2 -H lite-1 -H lite-3 -t "adhoc-one-hop-3-station" rtt_fair_var_$i
$F -H lite-1 -H lite-2 -H lite-3 -H lite-1 -t "adhoc-one-hop-3-station" rtt_fair_var_$i
$F -H lite-2 -H lite-3 -H lite-1 -H lite-2 -t "adhoc-one-hop-3-station" rtt_fair_var_$i
done 
